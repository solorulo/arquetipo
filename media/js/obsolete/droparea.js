(function( $ ){
    ...
    var m = {
        ...
        resize: function(file, input, area){
            ...
            reader.onloadend = function(e) { 
                ...
                if (data.length <= 6) {
                    s.error({
                        'error':'La imagen no se ha podido cargar. Inténtalo nuevamente.'
                    }, input, area);
                    return 0;					
                } else {
    ...
    $.fn.droparea = function(o) {
        ...
        s = {
            ...
            'start'       : m.start,
            'complete'    : m.complete,
            'instructions': 'arrastra la imagen aqui',
            'over'        : 'déjala caer!',
            'nosupport'   : 'El navegador no soporta la carga de archivos',
            'noimage'     : 'Tipo de archivo no soportado!',
            'uploaded'    : 'Listo!',
            'maxsize'     : '12' //Mb
        };
        if(o) $.extend(s, o);
